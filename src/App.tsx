...
const features = [
  {
    icon: Calendar,
    title: "课表",
    description: "简洁优雅的课程模块界面，灵活便利的切换方式，支持各学期切换、触发课程详情、自定义课程功能，让你的课表不再杂乱无章。"
  },
  {
    icon: Bell,
    title: "教务",
    description: "实时推送教务通知，同步更新考场信息，可视化学分、成绩、绩点分布，一键获取任课老师信息，轻松应对你的课业和考试。"
  },
  {
    icon: FileText,
    title: "历年卷",
  ...
  },
  {
    icon: MapPin,
    title: "空教室",
    description: "一键得知每天各时段教学楼空教室情况，帮助你寻找自习、班会地点。"
  },
  {
    icon: QrCode,
    title: "一码通",
  ...
  },
  {
    icon: Users,
    title: "嘉锡讲坛",
    description: "一键报名嘉锡讲坛，并轻松得知历次讲座情况。"
  },
  {
    icon: BookOpen,
    title: "学习中心",
    description: "快速预约学习中心学习座位，避免频繁卡顿"
  },
  {
    icon: Compass,
    title: "校园指南",
  ...
  },
  {
    icon: GraduationCap,
    title: "飞跃手册",
    description: "来自学长学姐的转专业、保研、考研、出国的经验手册"
  }
];
