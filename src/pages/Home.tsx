    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-accent/10">
        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <Badge
                variant="outline"
                className="mb-6 text-sm font-medium bg-primary/10 border-primary/20 text-primary"
              >
                原福大助手APP
              </Badge>

              <div className="flex items-center justify-center lg:justify-start gap-4 mb-6">
                <img src={fuuLogo} alt="福uu Logo" className="w-16 h-16 md:w-20 md:h-20 rounded-lg" />
                <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-foreground tracking-wide">福uu</h1>
              </div>

              <p className="text-lg md:text-xl font-semibold text-primary mb-4 md:mb-6">带来不一样的大学生活</p>
              <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl lg:max-w-none mx-auto lg:mx-0 mb-6 md:mb-8 leading-relaxed">
      ...
      <div className="container mx-auto px-4 py-20 hidden lg:block">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
          {[
            ...
            <div key={index} className="group">
              <Card className="text-card-foreground flex flex-col rounded-xl border shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-2 border-border/50 dark:border-border bg-card/80 backdrop-blur-sm">
                <div className="relative aspect-[9/16] overflow-hidden">
                  <img
                    src={screenshot.img}
                    alt={screenshot.title}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <Card
                key={index}
                className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-border/50 dark:border-border/80 bg-card/80 backdrop-blur-sm"
              >
      ...
      <footer className="bg-muted/30 border-t border-border">
        <div className="container mx-auto px-4 py-8 text-center">
          <p className="text-muted-foreground text-sm mb-2">© 福州西二在线网络有限公司 · 福uu助力您的大学生活</p>
